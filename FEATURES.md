...
8. [음식 버프 시스템](#8-음식-버프-시스템)
9. [GUI 시스템](#9-gui-시스템)
10. [명령어 목록](#10-명령어-목록)
11. [외부 플러그인 연동](#11-외부-플러그인-연동)
12. [권한 목록](#12-권한-목록)
...
- 특정 플레이어에게 귀속된 무기는 다른 플레이어가 사용 불가
- 귀속 아이템은 드롭 및 사망 시 드롭 방지
